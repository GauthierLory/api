 ...
 */
final class Version20190415181330 extends AbstractMigration
{
...
//        $this->addSql('CREATE TABLE article_picture (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');

...
class CommentController extends AbstractController
{
     ...
     */
    public function edit(Request $request, Comment $comment, HistoriqueHelper $historiquehelper): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $historiquehelper->new_modif($table="comment", $champ="atta", $old_comment, $new_comment, $historique, $comment->getId());

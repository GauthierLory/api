...
function adjustCSS( elem, prop, valueParts, tween ) {
	...
	if ( initialInUnit && initialInUnit[ 3 ] !== unit ) {
		...
		while ( maxIterations-- ) {
			...
			// Finish if the scale equals or crosses 1 (making the old*new article non-positive).
